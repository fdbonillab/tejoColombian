...
public class HighScoreTable:MonoBehaviour
{
    ...
    void OnGUI(){
        ...
        subLstTeams.setLstTeams(unScoreTeams.getHighScoreTeamList().GetRange(pagina , pagina+rowsPage ));
        highScoreEntryList = ScoresTeams2HighScoreEntry(subLstTeams);
        highScoreEntryTransformList = new List<Transform>();
        if(  !tablaMostrada && highScoreEntryList.Count > 0 && unScoreTeams.getHighScoreTeamList() != null ){
