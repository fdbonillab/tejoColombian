...
public class HighScoreTable:MonoBehaviour
{
    ...
    void OnGUI(){
        ...
        float left = 1f;
        entryContainer = transform.Find(NAME_HIGHSCORE_SCROLLVIEW).Find(NAME_HIGHSCORE_SCROLLVIEW_VIEWPORT).Find(NAME_HIGHSCORE_SCROLLVIEW_CONTENT);//transform.Find(NAME_HIGHSCORE_ENTRY_CONTAINER);
         /// scrollview viewport content
        entryTemplate = entryContainer.Find(NAME_HIGHSCORE_SCROLLVIEW).Find(NAME_HIGHSCORE_SCROLLVIEW_VIEWPORT).Find(NAME_HIGHSCORE_SCROLLVIEW_CONTENT).Find(NAME_HIGHSCORE_ENTRY_TEMPLATE);
