...
public class HighScoreTable:MonoBehaviour
{
    ...
    private Sprite buscarImgTeam(string _nameTeam){
        ...
        string _nameImgTeamDepartmentos = scriptSelectorEquipo.getImageTeamByName(_nameTeam);
        string _nameImgTeamFutbol = scriptSelectorEquipo.getImageTeamByName(_nameTeam);
        Sprite _sprite = atlasEquiposFutbol.GetSprite(_nameImgTeam);  
        if( _sprite == null ){
