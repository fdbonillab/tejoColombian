...
public class ScoreTeam
{
    ...
    public Resultado(int unNivel, int unObjetivo, int unScore, int unTurnos, bool unEsPC ){
     ...
     public Resultado(string unNick, int unNivel, int unObjetivo, int unScore, int unTurnos, bool unEsPC, string unfechaCreacion ){
        nick = unNick; nivel = unNivel; puntajeObjetivo = unObjetivo; score = unScore; turnos = unTurnos;  fechaCreacion = unfechaCreacion;
        esPC = unEsPC;
        //fechaCreacion = System.DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss");
        //fechaCreacion = System.DateTime.Now.ToString("dd");
    }
    ...
    public void setNickAnterior( string unNickAnterior){
