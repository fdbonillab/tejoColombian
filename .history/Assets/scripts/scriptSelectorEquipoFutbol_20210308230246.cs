...
public class scriptSelectorEquipoFutbol : MonoBehaviour
{
    ...
    public static string NAME_TOLIMA = "TolimaFutbol";
...
public static string NAME_PREF_TEAM_DEPARTAMENT = "PREF_TEAM_DEPARTAMENT";
public static string NAME_PREF_TEAM_FUTBOL = "PREF_TEAM_FUTBOL";
public static string NAME_TEXT_ESCOGE_EQUIPO = "TextEscogerEquipo";
  ...
  public  bool estaEnModoDepartamentos = false;
...
**/
    ...
    void Start()
    {
        ...
        int indice = 0;
        string teamEnPreference = PlayerPrefs.GetString(NAME_PREF_TEAM_FUTBOL);
        ...
        ///////////////////// este codigo esta en los dos selectores entonces hay q retirarlo en  ambos selectores
        ...
        if( estaEnModoDepartamentos ){
            return;
        }
        if( (teamEnPreference == null || teamEnPreference.Equals("")) ){
             //// un tema aca, como toco cargar el script equipos de futbol cuando se muestra los departamentos entonces esta traslapando
            /// los equipos de futbol sobre los equipos de departamentos
            for( int j = 0; j < 5; j++){
                for( int i = 0;i< 6; i++){
    ...
    private void escogerPrefEquipo( string nameTeam ){
        ...
        Debug.Log (" team en preferences "+teamEnPreference);
        if( teamEnPreference == null || teamEnPreference.Equals("")){
             PlayerPrefs.SetString( NAME_PREF_TEAM_FUTBOL,nameTeam );
        }
    }
    ...
    //// millonarios nacional santafe america tolima
    public void llenarListaEquiposFutbol(){
        Departamento elDepartamento = new Departamento(NAME_MILLONARIOS,1,NAME_IMG_ESCUDO_MILLONARIOS);
        if( lstEquiposFutbol == null ){
    ...
    public  string getImageTeamByName(string nameTeam ){
        Debug.Log ("***  getImageTeamByName futbol lstDepartamentos == null " +(lstEquiposFutbol == null));
        if( lstEquiposFutbol != null ){
    ...
    public List<Departamento> getListTeamsFutbol(){
        return lstEquiposFutbol;
    }
