...
public class Collision : MonoBehaviour
{
    ...
    */
    ...
    ///// orden del otro lado millonarios santafe america tolimna
     private void llenarListaTeamsFutbol(){
        ...
        elDepartamento = new Departamento( scriptSelectorEquipo.NAME_MILLONARIOS,2,scriptSelectorEquipo.NAME_IMG_ESCUDO_MILLONARIOS );
        lstTeamsFutbol.Add(elDepartamento);
         elDepartamento = new Departamento( scriptSelectorEquipo.NAME_MILLONARIOS,2,scriptSelectorEquipo.NAME_IMG_ESCUDO_MILLONARIOS );
        lstTeamsFutbol.Add(elDepartamento);
    }
