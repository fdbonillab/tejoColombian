...
**/
    ...
    void Start()
    {
        ...
        int indice = 0;
        string teamEnPreference = PlayerPrefs.GetString(scriptSelectorEquipoFutbol.NAME_PREF_TEAM_DEPARTAMENT);
    ...
    private void escogerPrefEquipo( string nameTeam ){
        ...
        Debug.Log (" team en preferences "+teamEnPreference);
        if( teamEnPreference == null || teamEnPreference.Equals("")){
             PlayerPrefs.SetString( scriptSelectorEquipoFutbol.NAME_PREF_TEAM_DEPARTAMENT,nameTeam );
        }
    }
    ...
    //// lo cual me llevo a copy pastear porque por las instalaciones no amerita una solucion mas elegante
