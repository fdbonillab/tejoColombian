    ...
    private void setBanderaEquipo(){
        ...
        if( lstTeamsFutbol == null ){
         ...
         if( teamEnPreference != null && !teamEnPreference.Equals("")){
              ...
              buttonEquipoDepartament.GetComponent<Button>().GetComponentInChildren<Text>().text = teamEnPreference;
              buttonEquipoFutbol.GetComponent<Button>().GetComponentInChildren<Text>().text = teamEnPreference;
         }
    }
