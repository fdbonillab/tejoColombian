    ...
    */
    ...
    ///// orden del otro lado millonarios nacional santafe america tolimn
     private void llenarListaTeamsFutbol(){
        Departamento elDepartamento = new Departamento( scriptSelectorEquipo.NAME_MILLONARIOS,1,scriptSelectorEquipo.NAME_IMG_ESCUDO_MILLONARIOS);
        lstTeamsFutbol = new List<Departamento>();
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipo.NAME_NACIONAL,2,scriptSelectorEquipo.NAME_IMG_ESCUDO_NACIONAL );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipo.NAME_SANTAFE,3,scriptSelectorEquipo.NAME_IMG_ESCUDO_SANTAFE );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipo.NAME_AMERICA,3,scriptSelectorEquipo.NAME_AMERICA );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipo.NAME_TOLIMA,3,scriptSelectorEquipo.NAME_TOLIMA );
        lstTeamsFutbol.Add(elDepartamento);
    }
