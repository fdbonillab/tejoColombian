    ...
    */
    ...
    ///// orden del otro lado millonarios nacional santafe america tolimn
     private void llenarListaTeamsFutbol(){
        ...
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipoFutbol.NAME_AMERICA,4,scriptSelectorEquipoFutbol.NAME_AMERICA );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipoFutbol.NAME_TOLIMA,5,scriptSelectorEquipo.NAME_TOLIMA );
        lstTeamsFutbol.Add(elDepartamento);
    }
