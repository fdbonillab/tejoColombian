...
public class Collision : MonoBehaviour
{
    ...
    public static string NOMBRE_SCENE_SELECT_TEAMS_FUTBOL = "selectorEquipo7";
    ...
    private void setBanderaEquipo(){
        if( lstDepartamentos == null){
         ...
         if( teamEnPreference != null && !teamEnPreference.Equals("")){
              ...
              buttonEquipo.gameObject.transform.GetChild(1).GetComponent<Image>().sprite = atlasDepartamentos.GetSprite(getImageTeamByName(teamEnPreference));
