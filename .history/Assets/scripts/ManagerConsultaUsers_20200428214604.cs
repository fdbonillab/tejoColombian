...
public class ManagerConsultaUsers : App42CallBack{
        ...
        public List<User> getListResultados(){
            if( lstResultados != null ){
                App42Log.Console("**** pidiendo get resultados count "+lstResultados.Count);
            }
