    ...
    */
    ...
    ///// orden del otro lado millonarios nacional santafe america tolimn
     private void llenarListaTeamsFutbol(){
        ...
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipoFutbol.NAME_SANTAFE,4,scriptSelectorEquipoFutbol.NAME_IMG_ESCUDO_SANTAFE );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipoFutbol.NAME_AMERICA,5,scriptSelectorEquipoFutbol.NAME_AMERICA );
        lstTeamsFutbol.Add(elDepartamento);
        elDepartamento = new Departamento( scriptSelectorEquipoFutbol.NAME_TOLIMA,6,scriptSelectorEquipo.NAME_TOLIMA );
        lstTeamsFutbol.Add(elDepartamento);
    }
