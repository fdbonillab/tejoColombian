...
public class ManagerScoresJson : App42CallBack
{
    ...
    */
    ...
    public void salvarScore(double elGameScore){
          Debug.Log ("**** salvando score con double  en app42 appwarp storageService");
    ...
    public void salvarScore(string unJson){ 
          Debug.Log ("**** salvando score con json en app42 appwarp storageService");
          if( storageService == null ){
             Start();
          }
          if(storageService != null ){
     ...
     public void salvarScore2( string unJson ){
          Debug.Log ("**** salvando score  hight en app42 appwarp storageService");
          if( storageService == null ){
             Start();
          }
          if(storageService != null ){
