...
string NAME_IMG_BANDERA_SUCRE = "Flag_of_Sucre_(Colombia).svg";
    ...
    int ID_TEAM_AMAZONAS = "Amazonas"; 
    string ID_TEAM_ANTIOQUIA = "Antioquia";
    string ID_TEAM_ARAUCA = "Arauca";
    string ID_TEAM_ATLANTICO = "Atlántico";
    string ID_TEAM_BOGOTA = "Bogotá";
    string ID_TEAM_BOLIVAR = "Bolívar";
    string ID_TEAM_BOYACA = "Boyacá";
    string ID_TEAM_CALDAS = "Caldas";
    string ID_TEAM_CAQUETA = "Caquetá";
    string ID_TEAM_CASANARE = "Casanare";
    string ID_TEAM_CAUCA = "Cauca";
    string ID_TEAM_CESAR = "Cesar";
    string ID_TEAM_CHOCO = "Chocó";
    string ID_TEAM_CORDOBA = "Córdoba";
    string ID_TEAM_CUNDINAMARCA = "Cundinamarca";
    string ID_TEAM_GUAINIA = "Guainía";
    string ID_TEAM_GUAVIARE = "Guaviare";
    string ID_TEAM_GUAJIRA = "Guajira";
    string ID_TEAM_MAGDALENA = "Magdalena";
    string ID_TEAM_META = "Meta";
    string ID_TEAM_NARINO = "Nariño";
    string ID_TEAM_NORTE_SANTANDER = "Norte de Santander";
    string ID_TEAM_PUTUMAYO = "Putumayo";
    string ID_TEAM_QUINDIO = "Quindío";
    string ID_TEAM_RISARALDA = "Risaralda";
    string ID_TEAM_SANTANDER = "Santander";
    string ID_TEAM_SUCRE = "Sucre";
    string ID_TEAM_TOLIMA = "Tolima";
    string ID_TEAM_VALLE_CAUCA = "Valle del Cauca";
    string ID_TEAM_VAUPES = "Vaupés";
    string ID_TEAM_VICHADA = "Vichada";
