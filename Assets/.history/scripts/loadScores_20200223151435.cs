...
public class loadScores : MonoBehaviour
{
   ...
   void OnGUI2(){
    ...
    void OnGUI()
    {
        ...
        scrollPosition = GUI.BeginScrollView(new Rect(10, 10, 690*factorScreenX, 470*factorScreenY), scrollPosition,//// x antes era 790
                       new Rect(0, 0, 1000*factorScreenX, 4300*factorScreenY )); /// el x era 1000 antes
