...
public class loadScores : MonoBehaviour
{
    ...
    void Update()
    {
        Text textDebug = GameObject.Find(Collision.TEXT_DEBUG).GetComponent<Text>();
   ...
   void OnGUI(){
    ...
    void testContains(){
        ...
        Resultado unResultado = new Resultado( "guest4490", 1, 10, 0, 0 );   
        lstResultadosTest.Add( unResultado );
        unResultado = new Resultado( "guest4491", 1, 10, 0, 0 );   
        lstResultadosTest.Add( unResultado );
        unResultado = new Resultado( "guest4492", 1, 10, 0, 0 );   
        lstResultadosTest.Add( unResultado );
