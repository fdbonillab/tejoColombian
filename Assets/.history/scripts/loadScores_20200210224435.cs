...
public class loadScores : MonoBehaviour
{
   ...
   void OnGUI2(){
    ...
    void OnGUI()
    {
        ...
        scrollPosition = GUI.BeginScrollView(new Rect(10, 10, 800*factorScreenX, 1000*factorScreenY), scrollPosition,
                       new Rect(0, 0, 900*factorScreenX, 1100*factorScreenY )); 
