...
public class Collision : MonoBehaviour
{
    ...
    */
    ...
    Resultado crearResultadoDePrueba(){
         Resultado resultadoPrueba = new Resultado();
         resultadoPrueba = new Resultado("usertest",LEVEL_1,PUNTAJE_OBJETIVO_10,11,2, false);
         ultimoResultado.setDeviceName( "device1" );
         ultimoResultado.setDeviceModel( "model1" );
