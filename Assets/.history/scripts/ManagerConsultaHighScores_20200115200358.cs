      ...
      public void OnSuccess(object response)  
        ...
        private void remplazarMejorScore(List lstResultados, Resultado elResultado){
            foreach(Resultado unResultado in lstResultados ){
                if( this.nick.Equals(other.nick) && this.getNivel() == other.getNivel() && this.getObjetivo() == other.getObjetivo() && this.getScore() == other.getScore() && this.getTurnos() == other.getTurnos() );
    }){ 
