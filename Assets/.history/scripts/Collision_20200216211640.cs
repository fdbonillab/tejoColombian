...
public class Collision : MonoBehaviour
{
    ...
    */
    ...
    void finJuego(){
        ...
        Button buttonScoreTeams = GameObject.Find (NAME_CANVAS).GetComponent<Transform>().Find(BUTTON_SCORES_TEAMS).GetComponent<Button>();
        buttonScoreTeams.gameObject.SetActive(true);
        finDeJuego = true;
