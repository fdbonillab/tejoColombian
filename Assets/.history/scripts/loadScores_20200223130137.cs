...
public class loadScores : MonoBehaviour
{
   ...
   void OnGUI2(){
    ...
    {   ///// este es el de backup para pruebas de concepto
        ...
        GUI.Button(new Rect(0, 300, 100, 20), "Top-left");
        GUI.Button(new Rect(0, 400, 100, 20), "Top-right");
        GUI.Button(new Rect(0, 500, 100, 20), "Bottom-left");
        GUI.Button(new Rect(0, 650, 100, 20), "Bottom-right");
        GUI.Button(new Rect(0, 700, 100, 20), "Top-left");
        GUI.Button(new Rect(0, 800, 100, 20), "Top-right");
        GUI.Button(new Rect(0, 900, 100, 20), "Bottom-left");
        GUI.Button(new Rect(0, 1200, 100, 20), "Bottom-right");
        // End the scroll view that we began above.
        GUI.EndScrollView();
    }
    ...
    */
    ...
    void mostrarHighScores(){
        ...
        if( lstResultados != null ){
            ...
            int limiteMostrar = lstResultados.Count;/// era 8 cuando no habia hecho el scroll
            int count = 0;
            foreach( Resultado resultado in lstResultados){
                ...
                rect.x = 50;
                //for(int i = 0; i < titulos.Length;i++){
                    GUI.Label(rect,""+(count+1),guiStyle );
                    rect.x += tabHorizontal-120;
