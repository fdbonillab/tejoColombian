    ...
    */
    ...
    public List<Resultado> getListResultados(){
      ...
      public void OnSuccess(object response)  
        ...
        private void remplazarMejorScore(List lstResultados, Resultado elResultado){
            foreach(Resultado unResultado in lstResultados ){
                if( unResultado.nick.Equals(other.nick) && elResultado.getNivel() == unResultado.getNivel() &&
                   elResultado.getObjetivo() == other.getObjetivo() && this.getScore() == other.getScore() && this.getTurnos() == other.getTurnos() );
    }){ 
