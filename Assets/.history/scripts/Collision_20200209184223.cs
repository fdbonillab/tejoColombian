...
public class Collision : MonoBehaviour
{
    ...
    /// revisando este tema otra vez, el limite esta cerca de los 50000 caracteres
         ...
         Debug.Log ("**** boton salir juego saliendo keydown 1");
            ...
            if( ultimoResultado != null ){
                ...
                if( PlayerPrefs.GetString(NAME_PREF_USERNAME_ANTERIOR) != null ){
                    ultimoResultado.setNickAnterior(string usernameEnPreferenceAnterior = PlayerPrefs.GetString(NAME_PREF_USERNAME_ANTERIOR););
                }
