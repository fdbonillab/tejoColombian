...
public class ManagerConsultaScoresJson : App42CallBack
{
    ...
    */
    ...
    public void consultarScores(){
          Debug.Log ("**** consultando  en app42 appwarp storageService");
          ...
          if(storageService != null ){
              ...
              if( contadorRegistros == 0){
                  storageService.FindAllDocumentsCount(dbName, collectionName, new ManagerConsultaScoresJson()); 
              } else {
    ...
    public List<Resultado> getLstResultados(){
        App42Log.Console("**** pidiendo get resultados ");
      ...
      public void OnSuccess(object response)  
            {  
                App42Log.Console("**** succes consulta scores app42 storageService max "+max);  
                ...
                if( storage.GetJsonDocList() != null ){
                    ...
                    {     
                        ...
                        lstResultados.Add( JsonUtility.FromJson<Resultado>(jsonDoc));
                        Debug.Log ("**** lstResultados "+lstResultados.Count);
                    }       
                    offset+=100;
                    max+=100;
                } else if (storage.GetTotalRecords() != null ){
