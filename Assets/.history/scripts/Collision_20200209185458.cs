...
public class Collision : MonoBehaviour
{
    ...
    string BUTTON_NEW_GAME = "ButtonCambiarNick";
    string BUTTON_CHANGE_NICK = "";
    ...
    */
    ...
    void finJuego(){
        ...
        Button buttonCambiarNick = GameObject.Find (NAME_CANVAS).GetComponent<Transform>().Find(BUTTON_NEW_GAME).GetComponent<Button>();
        buttonNewGame.gameObject.SetActive(true);
