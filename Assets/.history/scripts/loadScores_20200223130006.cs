...
public class loadScores : MonoBehaviour
{
   ...
   void OnGUI2(){
    ...
    {   ///// este es el de backup para pruebas de concepto
        ...
        GUI.Button(new Rect(0, 200, 100, 20), "Top-left");
        GUI.Button(new Rect(0, 250, 100, 20), "Top-right");
        GUI.Button(new Rect(0, 300, 100, 20), "Bottom-left");
        GUI.Button(new Rect(0, 350, 100, 20), "Bottom-right");
        // End the scroll view that we began above.
        GUI.EndScrollView();
    }
