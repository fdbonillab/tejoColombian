...
public class Collision : MonoBehaviour
{
    ...
    public static string NOMBRE_SCENE_HIGHSCORES = "tablaScores2";//// se cambia a tablascores3 antes era tablascores2
    ...
    public static void salirJuego(){
         Debug.Log ("**** boton salir juego saliendo keydown 1");
            ...
            if( ultimoResultado != null ){
                ...
                managerScoreJson.salvarScore(json); 
                new Collision().agregarResultadoEnHighScores(ultimoResultado);/// parece que como faltaba esta linea entonces el salir de android no actualizaba
