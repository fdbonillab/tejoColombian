...
public class loadScores : MonoBehaviour
{
   ...
   void OnGUI2(){
    ...
    {   ///// este es el de backup para pruebas de concepto
        ...
        GUI.Button(new Rect(200, 0, 100, 20), "Top-left");
        GUI.Button(new Rect(250, 0, 100, 20), "Top-right");
        GUI.Button(new Rect(300, 180, 100, 20), "Bottom-left");
        GUI.Button(new Rect(350, 180, 100, 20), "Bottom-right");
        // End the scroll view that we began above.
        GUI.EndScrollView();
    }
